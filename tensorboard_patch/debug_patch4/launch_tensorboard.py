...
USAGE="""
Purpose:
    Launches a "det tensorboard start <args>" process and streams logs and command output file distinct files.
...
TB_ID_REGEX = re.compile('Scheduling TensorBoard \([^\)]+\) \(id: ([a-z0-9-]{36}).*')
